...
public class BleConnector {
    ...
    private boolean isConnected() {
        return BleManager.getInstance().isConnected(mBleBluetooth.getDevice());
    }
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    ...
                    case BleMsg.MSG_CHA_NOTIFY_START: {
                        ...
                        if (notifyCallback != null && isConnected())
                    ...
                    case BleMsg.MSG_CHA_INDICATE_START: {
                        ...
                        if (indicateCallback != null && isConnected())
                    ...
                    case BleMsg.MSG_CHA_WRITE_START: {
                        ...
                        if (writeCallback != null && isConnected()) {
                    ...
                    case BleMsg.MSG_CHA_READ_START: {
                        ...
                        if (readCallback != null && isConnected())
                    ...
                    case BleMsg.MSG_READ_RSSI_START: {
                        ...
                        if (rssiCallback != null && isConnected())
                    ...
                    case BleMsg.MSG_SET_MTU_START: {
                        ...
                        if (mtuChangedCallback != null && isConnected())
